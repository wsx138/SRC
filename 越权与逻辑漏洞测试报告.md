...
**测试截图**: `vuln1_idor_user2-2026-07-22T07-48-49-112Z.png`
...
**测试截图**: `vuln3_vertical_idor_alice_to_admin-2026-07-22T07-50-19-677Z.png`
...
**测试截图**: `vuln2_before_recharge_50.png` → `vuln2_negative_500_before.png` → `vuln2_negative_500_after.png`
...
**结论**：`balance - 500 = -350`，等于从系统凭空提款 500 元，余额为负数！
...
**测试截图**:
- 充值前: `vuln4_alice_drain_admin_before-2026-07-22T07-50-32-788Z.png`（余额 ¥99,999）
- 充值后: `vuln4_alice_drain_admin_after-2026-07-22T07-50-39-412Z.png`（余额 ¥0）

#### 测试结果

| 攻击者 | 受害者 | 操作前余额 | 操作后余额 | 损失 |
|--------|--------|-----------|-----------|------|
| alice | admin | ¥99,999 | ¥0 | 全部余额 |
